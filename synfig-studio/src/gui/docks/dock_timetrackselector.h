...
#ifndef __SYNFIG_STUDIO_DIALOG_TIMETRACKSELECTOR_H
#define __SYNFIG_STUDIO_DIALOG_TIMETRACKSELECTOR_H
...
class Dock_TimetrackSelector : public Dock_CanvasSpecific
{
