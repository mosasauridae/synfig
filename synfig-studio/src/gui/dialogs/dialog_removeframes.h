...
#ifndef __SYNFIG_GTKMM_DIALOG_REMOVEFRAMES_H
#define __SYNFIG_GTKMM_DIALOG_REMOVEFRAMES_H
...
class Dialog_RemoveFrames : public Gtk::Dialog
{
...
public:
    ...
    Dialog_RemoveFrames(Gtk::Window &parent, synfig::Canvas::Handle canvas);
